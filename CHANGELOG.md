...
- Expanded the English beginner guide so it matches the Chinese guide structure and content, including Google Drive lookup, Customer Info usage, role-based daily use, and full troubleshooting sections.
